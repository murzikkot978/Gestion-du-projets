	...
	<div class="min-h-screen md:flex">
		<div class="flex items-center justify-center w-full md:w-1/2">
			<div class="max-w-sm m-8">
				...
				<p class="mb-8 text-2xl font-light text-gray-800 md:text-3xl"><?php _e('Sorry, the page you are looking for could not be found.', 'TrivialForge'); ?></p>
				<a href="<?php echo get_bloginfo('url'); ?>" class="px-4 py-2 text-white rounded bg-primary">
					<?php _e('Go Home', 'TrivialForge'); ?>
				</a>
			</div>
		</div>
	</div>
